...
function NavigationMenuNoTrigger({ className, children, asChild = false, ...props }: React.ComponentProps<"button"> & { asChild?: boolean }) {
  const Comp = asChild ? Slot : "button";
  return (
    <Comp data-slot="navigation-menu-no-trigger" className={cn(navigationMenuTriggerStyle(), "cursor-pointer", className)} {...props}>
      {children}
    </Comp>
  );
}
...
function NavigationLogo({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return <NavigationMenuPrimitive.Link data-slot="navigation-menu-logo" className={cn("flex items-center justify-center", className)} {...props} />;
}
...
export { NavigationLogo, NavigationMenu, NavigationMenuContent, NavigationMenuIndicator, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, NavigationMenuNoTrigger, navigationMenuNoTriggerStyle, NavigationMenuTrigger, navigationMenuTriggerStyle, NavigationMenuViewport };
